...
const useStore = () => {
  ...
  return {
    ...
    // addToCart: useCallback(() => setCartCount((cartCount + 1)),[cartCount]) //empty [] would be stale callback
    addToCart: useCallback(() => setCartCount((v) => v + 1), []) // prevents rerender of button
  }
}
